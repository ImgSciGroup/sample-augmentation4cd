...
class ISBI_Loader(Dataset):
    def __init__(self, data_path, transform=None):
        ...
        self.imgs_path = glob.glob(os.path.join(data_path, 'im1/*.bmp'))
    ...
    def __getitem__(self, intex):
        ...
        label_path = image1_path.replace('im1', 'label')
...
if __name__ == "__main__":
    ...
    imgs_path = glob.glob(os.path.join("../data/LEVER-138/", 'im1/*.bmp'))
    len1 = len(imgs_path)
    print(len1)
